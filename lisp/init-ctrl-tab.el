;;; https://www.emacswiki.org/emacs/ControlTABbufferCycling#h5o-3
...
(setq stesla-hated-buffers '("*Completions*" "*grep*" "*vc*" "*Compile-Log*" "*Help*" "*Messages*"))
